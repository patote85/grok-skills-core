...
1. **Is an agent actually required?**
   ...
   - Measure the gain. Reject the agent if latency, cost or failure surface increases without clear improvement.
